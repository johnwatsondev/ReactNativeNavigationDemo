package com.reactnativenavigationdemo.reactnative.base;
...
/**
 * Created by johnwatsondev on 14/06/2017.
 */
public class ReactActivityDelegate {

  private final int REQUEST_OVERLAY_PERMISSION_CODE = 1111;

  private static final String REDBOX_PERMISSION_MESSAGE = "需要授权悬浮窗权限才能打开页面，请授权";
  ...
  protected void onCreate(Bundle savedInstanceState, Bundle mAppProperties) {
  ...
  protected void loadApp(String appKey) {
    ...
    mReactRootView.startReactApplication(getReactNativeHost().getReactInstanceManager(), appKey,
        getLaunchOptions());
  ...
  protected void onResume() {
    if (getReactNativeHost().hasInstance()) {
      getReactNativeHost().getReactInstanceManager()
          .onHostResume(getPlainActivity(), (DefaultHardwareBackBtnHandler) getPlainActivity());
    }
  ...
  //*********************** New Add By Myself start *********************

  protected @Nullable Bundle getLaunchOptions() {
    return mAppProperties;
  }

  //*********************** New Add By Myself end ***********************
}